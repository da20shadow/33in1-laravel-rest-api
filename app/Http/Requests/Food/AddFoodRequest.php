...
class AddFoodRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'calories' => ['required','numeric','between:1,10000'],
            'carbs' => ['sometimes','numeric','between:0,10000'],
            'protein' => ['sometimes','numeric','between:0,10000'],
            'fat' => ['sometimes','numeric','between:0,10000'],
            'category' => ['required','string',Rule::in(['Appetizer','Fruits salad','Vegetable salad','Soup','Fish','Main dish','Roast','Dessert','Snack'])],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'category.required' => 'Please add food category!',
        ];
    }
}
